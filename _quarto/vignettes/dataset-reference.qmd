...
**Dataset:** `superman_smes` \| **47 rows, 6 columns**

Simulated participant ratings on the Subjective Media Experience Scale (SMES), grouped by both the height gap and age difference between the Superman and Lois Lane actors. All variables are already numeric — no data prep conversion is needed.
