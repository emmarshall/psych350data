...
The psyc350data package provides all the datasets you need for PSYC 350 labs. Each dataset is pre-cleaned and ready to use — no downloading files, no import headaches. You can also export any dataset as a fully labeled SPSS (.sav) file with a single function call.
