...
matches SPSS output exactly. This is also useful when working with
[psych350lab](https://github.com/emmarshall/psych350lab) functions that
expect numeric grouping variables:
...
Export the full dataset as an instructor answer key, and a subset as the
student version:
